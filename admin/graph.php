<?php
	  ...
	  //echo $str;
	  if($str=='select * from feedback_master order')
	  {
	  ...
	  else
	  {
			  ...
			  $total_std=mysql_num_rows($res);
				...
				else
				{
						...
						$result1=mysql_query($str) or die(mysql_error());
						$total_ans1=0;
						$total_ans2=0;
						$total_ans3=0;
						$total_ans4=0;
					...
					$graphTitle = "Teacher Name: ".faculty_name($arr1['f_id'])."  Subject: ".subject_name($arr1['sub_id'])."    Batch: ".batch_name($arr1['batch_id'])." - Sem: ".sem_name($arr1['sem_id'])." - Div: ".division_name($arr1['division_id'])." ( Feedback ".$arr1['feedback_no']." )   Date: ".date('d-m-Y'); 
					...
					$data['Doubt Clearing'] = $total_ans6/$total_std; 
					$data['Respected'] = $total_ans7/$total_std;
					$data['Instrumental'] = $total_ans8/$total_std;
					$data['Age'] = $total_ans9/$total_std; 
