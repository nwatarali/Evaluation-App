...
<title>View Evaluation result</title>
<style type="text/css">
<!--
...
<table width="727" height="171" border="0" align="center" cellpadding="5" cellspacing="5" bordercolor="#808080" style="border-collapse: collapse">
  ...
  <tr>
	...
	<?php $sql="select * from result_master where roll_no='".$_POST['roll_no']."' and b_id='".$_POST['b_id']."'";
    ...
    <table width="247" border="0" align="center" bordercolor="#000000">
      ...
      <tr>
        ...
        <td align="left">
		  ...
		  <?php $sql="select * from branch_master where b_id=".$row['b_id'];
		  $res=mysql_query($sql) or die(mysql_error());
